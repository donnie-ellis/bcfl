-- Revised function to update create_draft_with_picks without changing return type
...
-- Ensure the function has the correct owner
ALTER FUNCTION public.create_draft_with_picks(TEXT, TEXT, INTEGER, INTEGER, JSONB, TEXT, JSONB) OWNER TO postgres;

-- Grant necessary permissions
GRANT EXECUTE ON FUNCTION public.create_draft_with_picks(TEXT, TEXT, INTEGER, INTEGER, JSONB, TEXT, JSONB) TO anon;
